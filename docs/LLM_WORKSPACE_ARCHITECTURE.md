...
| **B7h-m** | **Casting — the migration** | The only list operation still carrying its own engine. Also needs the bench Approve path and confirmation wording for `applySelectedCastingSuggestions`. | none |
