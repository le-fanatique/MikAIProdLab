    ...
    <>
      ...
      {collapsed && (
        <button
          ...
          title="Open chat"
          className="fixed bottom-6 right-6 z-30 flex items-center justify-center w-11 h-11 rounded-full border border-[#2c3035] text-[#e7e9ec] shadow-lg hover:border-[#5b93d6]/50 hover:text-[#5b93d6] transition-colors"
